        ...
        <div className="footer-content">
          ...
          <div className="text-center mb-8 sm:mb-12">
            <div className="flex items-center justify-center gap-2 sm:gap-3 mb-3 sm:mb-4">
              <svg
                viewBox="0 0 100 50"
                className="w-12 h-6 sm:w-16 sm:h-8 text-gold"
                fill="none"
              >
                <path
            ...
            <h3 className="font-serif text-2xl sm:text-3xl tracking-wide mb-1 sm:mb-2">Tina Ribéro</h3>
          ...
          <div className="flex justify-center gap-3 sm:gap-4 mb-8 sm:mb-12">
            {[
              { name: 'instagram', url: 'https://instagram.com/tinariberoeventos' },
              { name: 'facebook', url: 'https://facebook.com/tinariberoeventos' },
          ...
          <div className="text-center border-t border-cream/10 pt-6 sm:pt-8">
            <p className="font-sans text-xs sm:text-sm text-cream/40">
              © {currentYear} Tina Ribéro Assessoria & Eventos. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </div>
