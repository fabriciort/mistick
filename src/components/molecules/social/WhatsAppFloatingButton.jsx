...
/**
 * WhatsAppFloatingButton Molecule - Botão flutuante do WhatsApp
 */
const WhatsAppFloatingButton = ({ className = '' }) => {
  ...
  return (
    <div className={`fixed bottom-20 sm:bottom-24 right-4 sm:right-6 md:right-8 z-50 safe-area-bottom ${className}`}>
      {/* Tooltip */}
      <div
      ...
      >
        <SocialIcon name="whatsapp" className="w-6 h-6 sm:w-7 sm:h-7" />
