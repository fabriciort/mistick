/**
 * @fileoverview Logo atom component
 * Animated Mistick logo with GSAP drawing effect
 */
...
/**
 * @typedef {'dark' | 'light'} LogoVariant
 */
...
/**
 * Mistick Logo with animated drawing effect
 * @param {Object} props
 * @param {string} [props.className='w-full max-w-lg'] - Container classes
 * @param {number} [props.delay=0] - Animation delay
 * @param {LogoVariant} [props.variant='dark'] - Color variant
 * @param {boolean} [props.animate=true] - Enable animation
 */
const Logo = ({ 
...
/**
 * Simple static logo without animation (for performance)
 */
export const LogoStatic = memo(({ className, variant = 'dark' }) => {
  const currentColors = COLORS[variant] || COLORS.dark
...
LogoStatic.displayName = 'LogoStatic'
