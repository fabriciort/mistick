  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(logoContainerRef.current,
        ...
        { scale: 1, opacity: 1, y: 0, duration: ANIMATION_THEME.duration.lg, ease: ANIMATION_THEME.ease.enter, delay: 0.3 }
      )

      // CTA buttons with light shimmer effect
      gsap.fromTo('.hero-cta',
        { y: 30, opacity: 0 },
        { y: 0, opacity: 1, duration: ANIMATION_THEME.duration.md, ease: ANIMATION_THEME.ease.enter, delay: 1.2 }
      )

      // Scroll indicator
      gsap.fromTo('.scroll-indicator',
        { y: -10, opacity: 0 },
        { y: 0, opacity: 1, duration: ANIMATION_THEME.duration.sm, ease: ANIMATION_THEME.ease.enter, delay: 1.8 }
      )
      ...
      gsap.to('.scroll-indicator-arrow', {
        ...
        repeat: -1,
        yoyo: true,
        ease: ANIMATION_THEME.ease.loop,
        delay: 2.2,
      })
    }, heroRef)
