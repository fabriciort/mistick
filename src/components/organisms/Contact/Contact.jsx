...
import { getWhatsAppLink, openWhatsApp } from '../../../utils/whatsapp'
    ...
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo(formRef.current,
        { y: 30, opacity: 0 },
        {
          y: 0,
          opacity: 1,
          duration: ANIMATION_THEME.duration.md,
      ...
      gsap.fromTo('.contact-card',
        { y: 20, opacity: 0 },
        {
          y: 0,
          opacity: 1,
          duration: ANIMATION_THEME.duration.xs,
          stagger: ANIMATION_THEME.stagger.sm,
          ease: ANIMATION_THEME.ease.enter,
          scrollTrigger: {
