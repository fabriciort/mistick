...
import { prepareSVGPaths, animateSVGDraw } from '@shared/lib/gsap/helpers'

/**
 * MistickLogo Component
 * 
 * Logo animado da marca Mistick com efeito de desenho SVG.
 * 
 * @param {Object} props
 * @param {string} props.className - Classes CSS para o container
 * @param {number} props.delay - Delay inicial da animação
 * @param {'dark'|'light'} props.variant - Variante de cor
 */
const MistickLogo = ({
